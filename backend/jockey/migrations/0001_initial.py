    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jockey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jockey.master')),
            ],
            options={
                'verbose_name': '騎手成績',
        ...
        migrations.AddConstraint(
            model_name='jockeyresult',
            constraint=models.UniqueConstraint(fields=('year', 'jockey_id'), name='jockey_result_unique'),
        ),
    ]
